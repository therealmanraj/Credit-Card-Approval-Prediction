...
train_original = pd.read_csv(
    "https://raw.githubusercontent.com/therealmanraj/Credit-Card-Approval-Prediction/main/dataset/train.csv"
)

test_original = pd.read_csv(
    "https://raw.githubusercontent.com/therealmanraj/Credit-Card-Approval-Prediction/main/dataset/test.csv"
)
...
print(f"Length of profile_to_predict: {len(profile_to_predict)}")
print(f"Number of columns in train_copy: {len(train_copy.columns)}")

print(f"Length of profile_to_predict: {(profile_to_predict)}")
print(f"Number of columns in train_copy: {(train_copy.columns)}")
